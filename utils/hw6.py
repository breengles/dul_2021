...
def q1_save_results(dset_id, fn):
    ...
    plot_vae_training_plot(
        train_losses, test_losses, f"Q1 Dataset {dset_id} Train Plot", f"results/q1_dset{dset_id}_train_plot.png"
    )
    show_samples(samples, title=f"Q1 Dataset {dset_id} Samples", fname=f"results/q1_dset{dset_id}_samples.png")
    show_samples(
        reconstructions,
        title=f"Q1 Dataset {dset_id} Reconstructions",
        fname=f"results/q1_dset{dset_id}_reconstructions.png",
    )
    show_samples(
        interpolations,
        title=f"Q1 Dataset {dset_id} Interpolations",
...
def q2_save_results(dset_id, fn):
    ...
    save_training_plot(
        vqvae_train_losses,
        vqvae_test_losses,
        f"Q2 Dataset {dset_id} VQ-VAE Train Plot",
    ...
    show_samples(samples, title=f"Q2 Dataset {dset_id} Samples", fname=f"results/q2_dset{dset_id}_samples.png")
    show_samples(
        reconstructions,
...
def b4_a_save_results(dset_id, fn):
    ...
    save_training_plot(
        vqvae_train_losses,
        vqvae_test_losses,
        f"B4(a) Dataset {dset_id} VQ-VAE Train Plot",
    ...
    show_samples(samples, title=f"B4(a) Dataset {dset_id} Samples", fname=f"results/b4_a_dset{dset_id}_samples.png")
    show_samples(
        reconstructions,
...
def b4_b_save_results(fn):
    ...
    plot_vae_training_plot(train_losses, test_losses, f"B4({part}) Train Plot", f"results/b4_{part}_train_plot.png")
    show_samples(samples, title=f"b4({part}) Samples", fname=f"results/b4_{part}_samples.png")
    show_samples(reconstructions, title=f"B4({part}) Reconstructions", fname=f"results/b4_{part}_reconstructions.png")
